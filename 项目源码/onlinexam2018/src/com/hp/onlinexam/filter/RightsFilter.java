...
//		System.out.println(targetURL);
		if (!targetURL.startsWith("/bootstrap") && !targetURL.equals("/") && !targetURL.startsWith("/css") && !targetURL.startsWith("/js") && !targetURL.startsWith("/img")) {
			if (o == null && !targetURL.equals("/login.jsp")) {
				if (!targetURL.equals("/loginServlet")
						&& !targetURL.equals("/img/login.jpg")) {
