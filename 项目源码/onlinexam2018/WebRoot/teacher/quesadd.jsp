...
<div class = "container">
		<form id="form1" name="form1" method="post"
			...
			<div class = "form-group">
				<label>题目类型：</label>
				<select name="queType" class = "form-control" id="queType"
          ...
          <option value="3">判断对错</option> -->
			...
			<div class = "form-group">
				<label>题目：</label>
				<textarea name="queTitle" class = "form-control" id="queTitle" style="resize: none;"></textarea>
			</div>
			<div class = "form-group">
				<label>选项A：</label>
			...
			<input type="submit" name="button" class="btn btn-success" id="button" value="增加试题" />
		</form>
</div>
</body>
</html>