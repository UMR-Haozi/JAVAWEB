...
<div class = "container">
	...
	<div id="main_content">
		<div>
			<form id="form1" name="form1" method="post" action="<%=path %>/studentTestServlet?&testId=${test.id}">
				<div id="fd">
				...
				<div id="time"></div>
				<center>
					<p>课程:${test.courseName} &nbsp;&nbsp;&nbsp;班级: ${test.className}
						&nbsp;&nbsp;&nbsp;姓名:${user.name }</p>
				</center>
				<%
				...
				<c:forEach var="que" items="${quesList}" varStatus="status">
					...
					<p>D.${que.choiceD }</p>
					<p>
					A.<input type="radio" checked="checked" name = "ques_${que.id}" value = "A"/>
				...
				<p>&nbsp;</p>
					<center>
						<input type="submit" class = "btn btn-info btn-lg"name="button" id="button" value="交卷"
